...
const toolIcons = [
  { name: 'Ai', color: '#FF9A00', position: 'top-[10%] left-[5%]' },
  { name: 'Ps', color: '#31A8FF', position: 'top-[25%] right-[8%]' },
  { name: 'Xd', color: '#FF61F6', position: 'top-[60%] right-[2%]' },
  { name: 'Fg', color: '#A259FF', position: 'bottom-[15%] right-[15%]' },
  { name: 'Sk', color: '#F7B500', position: 'bottom-[10%] left-[10%]' },
];
...
const HeroSection = () => {
  return (
    <section id="home" className="relative min-h-screen flex items-center overflow-hidden">
      ...
      {/* Animated glow */}
      <div className="absolute top-1/2 right-1/4 w-[600px] h-[600px] rounded-full opacity-30 blur-3xl animate-pulse-glow"
          ...
          >
            ...
            >
              <img
                src={designerPhoto}
                alt="Designer"
                className="w-[280px] md:w-[350px] object-contain relative z-10"
              />
            </motion.div>
            ...
            {toolIcons.map((tool, index) => (
              <motion.div
                ...
                className={`floating-icon w-12 h-12 md:w-14 md:h-14 ${tool.position} animate-float`}
